...
import type { FlatListProps, ViewStyle, TextStyle, ImageStyle } from "react-native";
...
export interface RendererInterface {
    ...
    custom(identifier: string, raw: string, children?: ReactNode[], args?: Record<string, unknown>): ReactNode;
}
...
export type Token = marked.Tokens.Space | marked.Tokens.Code | marked.Tokens.Heading | marked.Tokens.Table | marked.Tokens.Hr | marked.Tokens.Blockquote | marked.Tokens.List | marked.Tokens.ListItem | marked.Tokens.Paragraph | marked.Tokens.HTML | marked.Tokens.Text | marked.Tokens.Def | marked.Tokens.Escape | marked.Tokens.Tag | marked.Tokens.Image | marked.Tokens.Link | marked.Tokens.Strong | marked.Tokens.Em | marked.Tokens.Codespan | marked.Tokens.Br | marked.Tokens.Del | CustomToken;
