...
const getStyles = (userStyles, colorScheme, userTheme) => {
  ...
  return StyleSheet.create({
    em: StyleSheet.flatten([fontStyle.regular, {
      fontStyle: "italic"
    }, userStyles?.em]),
    strong: StyleSheet.flatten([fontStyle.regular, {
      fontWeight: "bold"
    }, userStyles?.strong]),
    strikethrough: StyleSheet.flatten([fontStyle.regular, {
      textDecorationLine: "line-through",
      textDecorationStyle: "solid"
    }, userStyles?.strikethrough]),
    text: StyleSheet.flatten([fontStyle.regular, userStyles?.text]),
    paragraph: StyleSheet.flatten([fontStyle.regular, {
      paddingVertical: mdSpacing.m
    }, userStyles?.paragraph]),
    link: StyleSheet.flatten([fontStyle.regular, {
      fontStyle: "italic",
      color: mdColors.link
    }, userStyles?.link]),
    ...
    h1: StyleSheet.flatten([fontStyle.heading, {
      fontSize: 32,
      lineHeight: 40,
      fontWeight: "bold",
    ...
    h2: StyleSheet.flatten([fontStyle.heading, {
      fontSize: 28,
      lineHeight: 36,
      marginVertical: mdSpacing.m,
      paddingBottom: mdSpacing.s,
    ...
    h3: StyleSheet.flatten([fontStyle.heading, {
      fontSize: 24,
      lineHeight: 32,
      marginVertical: mdSpacing.s
    }, userStyles?.h3]),
    h4: StyleSheet.flatten([fontStyle.heading, {
      fontSize: 22,
      lineHeight: 28,
      marginVertical: mdSpacing.s
    }, userStyles?.h4]),
    h5: StyleSheet.flatten([fontStyle.regular, fontStyle.heading, {
      marginVertical: mdSpacing.xs
    }, userStyles?.h5]),
    h6: StyleSheet.flatten([fontStyle.heading, {
      fontSize: 14,
      lineHeight: 20,
      marginVertical: mdSpacing.xs
    }, userStyles?.h6]),
    codespan: StyleSheet.flatten([fontStyle.regular, {
      fontStyle: "italic",
    ...
    li: StyleSheet.flatten([fontStyle.regular, {
      flexShrink: 1
    }, userStyles?.li]),
