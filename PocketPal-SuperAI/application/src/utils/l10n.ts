...
export const l10n = {
  en: {
    ...
    settings: {
      ...
      // MCP Settings
      mcpServersTitle: 'MCP Servers (experimental)',
      mcpServersDescription: 'Connect to Model Context Protocol servers for extended tool capabilities.',
      mcpServerName: 'Server Name',
      mcpServerNamePlaceholder: 'My MCP Server',
      mcpServerUrl: 'WebSocket URL',
      mcpServerUrlPlaceholder: 'ws://localhost:3000',
      ...
      mcpConnect: 'Connect',
      mcpRemove: 'Remove',
      mcpToolsAvailable: '{{count}} tools available',
      mcpNoTools: 'No tools',
    ...
    components: {
      ...
      chatInput: {
        ...
        mcpToolsButton: 'Tools',
        mcpToolsModalTitle: 'Run MCP Tool',
        mcpSelectTool: 'Select a tool',
        mcpToolArguments: 'Tool Arguments (JSON)',
        mcpRunTool: 'Run Tool',
        mcpToolError: 'Tool execution failed',
        mcpNoToolsAvailable: 'No tools available. Connect to an MCP server in Settings.',
      },
  ...
  ja: {
    ...
    settings: {
      ...
      // MCP Settings
      mcpServersTitle: 'MCPサーバー (実験的)',
      mcpServersDescription: 'Model Context Protocolサーバーに接続して拡張ツール機能を使用します。',
      mcpServerName: 'サーバー名',
      mcpServerNamePlaceholder: 'マイMCPサーバー',
      mcpServerUrl: 'WebSocket URL',
      mcpServerUrlPlaceholder: 'ws://localhost:3000',
      ...
      mcpConnect: '接続',
      mcpRemove: '削除',
      mcpToolsAvailable: '{{count}}個のツールが利用可能',
      mcpNoTools: 'ツールなし',
      mcpConnectionError: '接続失敗',
    },
    memory: {
      shortWarning: 'メモリ警告',
      warning:
    ...
    components: {
      ...
      chatInput: {
        ...
        mcpToolsButton: 'ツール',
        mcpToolsModalTitle: 'MCPツールを実行',
        mcpSelectTool: 'ツールを選択',
        mcpToolArguments: 'ツール引数 (JSON)',
        mcpRunTool: 'ツールを実行',
        mcpToolError: 'ツール実行失敗',
        mcpNoToolsAvailable: 'ツールが利用できません。設定でMCPサーバーに接続してください。',
      },
      chatGenerationSettingsSheet: {
        invalidValues: '無効な値',
  ...
  zh: {
    ...
    settings: {
      ...
      // MCP Settings
      mcpServersTitle: 'MCP服务器 (实验性)',
      mcpServersDescription: '连接到Model Context Protocol服务器以获得扩展工具功能',
      mcpServerName: '服务器名称',
      mcpServerNamePlaceholder: '我的MCP服务器',
      mcpServerUrl: 'WebSocket URL',
      mcpServerUrlPlaceholder: 'ws://localhost:3000',
      mcpAddServer: '添加服务器',
      mcpNoServers: '未配置MCP服务器',
      mcpConnected: '已连接',
      mcpDisconnected: '未连接',
      mcpConnect: '连接',
      mcpRemove: '删除',
      mcpToolsAvailable: '{{count}}个工具可用',
      mcpNoTools: '无工具',
    ...
    components: {
      ...
      chatInput: {
        inputPlaceholder: '消息',
        mcpToolsButton: '工具',
        mcpToolsModalTitle: '运行MCP工具',
        mcpSelectTool: '选择工具',
        mcpToolArguments: '工具参数 (JSON)',
        mcpRunTool: '运行工具',
        mcpToolError: '工具执行失败',
        mcpNoToolsAvailable: '无可用工具。请在设置中连接MCP服务器。',
      },
      chatGenerationSettingsSheet: {
        invalidValues: '无效值',
